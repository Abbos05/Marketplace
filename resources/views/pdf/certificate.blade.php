...
<head>
    ...
    <style>
        @font-face {
            ...
            unicode-range: U+0000-00FF, U+0100-017F, U+0400-04FF;
            /* Кириллица */
        }
...
<body>
    <div class="receipt {{ $type == 'Отказано' ? 'bred' : 'bgreen' }}">
        <div class="header">
            ...
            <div class="subtitle">ALVORA — Официальная торговая площадка NFT</div>
        </div>

        <div class="item"><span class="item-label">Тип:</span> <span class="item-value">{{ $type }}</span></div>
        <div class="item"><span class="item-label">NFT:</span> <span class="item-value">{{ $product_title }}</span></div>
        <div class="item"><span class="item-label">ID NFT:</span> <span class="item-value">#{{ $product_id }}</span></div>
        ...
        <div class="footer">
            © 2025 ALVORA. Все права защищены.<br>
