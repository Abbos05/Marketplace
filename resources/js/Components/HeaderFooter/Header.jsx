...
const Header = ({ setIsModalOpen }) => {
  ...
  const renderMessagesAction = () => {
    ...
    const icon = (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 -1.5 24 24" fill="none" className="products__basket">
        <path
          fill="currentColor"
          stroke="currentColor"
          stroke-width="0.5"
        ...
        />
        <line x1="8" y1="8.5" x2="17" y2="8.5" stroke="currentColor" strokeWidth="2.2" />
        <line x1="8" y1="12" x2="15" y2="12" stroke="currentColor" strokeWidth="2.2" />
      </svg>
    );
        ...
        <Link href="/favorites" className="header-wallet">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path 
             transform="scale(1.1)"
              transform-origin="12 12"
            fill="currentColor" d="M3 10.163C3 7.262 5.13 5 8 5c1.929 0 3.244 1.102 4 2.066C12.756 6.102 14.071 5 16 5c2.87 0 5 2.264 5 5.163 0 4.561-4.568 7.856-8.243 9.66a1.71 1.71 0 0 1-1.514 0C7.568 18.02 3 14.724 3 10.163" />
          </svg>
          <p>Избранное</p>
        </Link>
      </div>
  ...
  const renderSearchIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <circle cx="11" cy="11" r="7" stroke="currentColor" strokeWidth="3.3" />
      <path d="M16.2 16.2L22 22" stroke="currentColor" strokeWidth="3.3" strokeLinecap="round" />
    </svg>
  );
  ...
  const renderMobileHeaderActions = () => (
    <>
      ...
      <div className="header-action-item wallet-btnRelative">
        <Link href="/messages" className="header-wallet">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 -1.5 24 24" fill="none" className="products__basket">
            <path
              fill="currentColor"
              stroke="currentColor"
